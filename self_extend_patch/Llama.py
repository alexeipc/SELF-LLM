...
def self_extend_forward(
    ...
    **kwargs,
    ...
    group_query_position, group_key_position = generate_logistically_grouping_position(query_position.shape[1], group_size_2, capacity=group_size_1, device=device)
...
def flash_self_extend_forward(
    ...
    **kwargs,
    ...
    if q_len == 1:
        ...
        device = value_states.device
        group_key_position = generate_logistically_grouping_position(key_position.shape[1], group_size_2, capacity=group_size_2, device=device, qlen_1 = True)
